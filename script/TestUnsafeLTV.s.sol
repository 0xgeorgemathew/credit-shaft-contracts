...
contract TestUnsafeLTV is Script {
    ...
    function setUp() public {
        ...
        usdc = IERC20(0xCaC7Ffa82c0f43EBB0FC11FCd32123EcA46626cf);
        link = IERC20(0x3A38c4d0444b5fFcc5323b2e86A21aBaaf5FbF26);
    }
    ...
    function run() external {
        ...
        uint256 targetLTV = 4900; // 67% - above our 65% automation threshold but below Aave's 70% max LTV
    ...
    function _calculateLTV(address user) internal view returns (uint256) {
        (,, uint256 borrowedUSDC, uint256 suppliedLINK,,,,, bool isActive,,,,) = creditShaftLeverage.positions(user);
